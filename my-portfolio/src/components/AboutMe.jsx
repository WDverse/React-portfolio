      ...
      <div className="about" style={{ backgroundColor: "white" }}>
        ...
        <div className="about-body">
          <div>
            ...
            to create seamless web solutions. I'm enrolled in a Carleton
            University Web Development Bootcamp, where I have gained experience
            in{" "}
            <span>
              HTML, CSS, Bootstrap, JavaScript, React.Js, Node.Js and more
            </span>
            . In addition, through my ongoing graduate studies in Technology
            Innovation Management, I have aquired software project managemt
